...
> native SDK. Use the `openai` Python package with a configurable `base_url`/`api_key`; no vendoring under
> `sdk/` is needed for it. See root [`ARCHITECTURE.md`](./ARCHITECTURE.md) §2.1.
